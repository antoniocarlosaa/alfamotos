# Guia de Deploy na Vercel - Alfa Motos - Catálogo de Veículos v2.0
...
3.  Na lista "Import Git Repository", você deve ver o seu repositório `alfa-motos-inventory` (ou o nome que você deu). Clique em **"Import"**.
