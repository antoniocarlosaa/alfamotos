                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center justify-center gap-1 transition-all duration-300 w-12 ${isActive ? 'text-red-500 -translate-y-2' : 'text-white/40 hover:text-white/60'
                                }`}
                        >
                            <div className={`p-1.5 rounded-full transition-all ${isActive ? 'bg-red-500/10' : 'bg-transparent'}`}>
