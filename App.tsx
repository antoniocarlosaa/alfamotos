    ...
    <div className="flex flex-col min-h-screen bg-background font-sans relative">
      ...
      <div className="flex w-full min-h-screen">
        ...
        <main className="flex-1 w-full pb-24 md:pl-64 bg-[#050505]">
          ...
          <div className="md:hidden w-full h-16 flex items-center justify-center border-b border-white/5 bg-[#050505]/80 backdrop-blur-md sticky top-0 z-40">
            <h1 className="flex items-center gap-2">
              <span className="text-xl font-heading font-bold italic text-white tracking-tighter">
          ...
          <div className="-mt-32 relative z-20 mb-12 px-4">
          ...
          <div className="w-full max-w-sm bg-surface border border-white/10 rounded-3xl p-6 shadow-2xl relative overflow-hidden" onClick={e => e.stopPropagation()}>
            <div className="flex justify-between items-center mb-6">
              <div>
                ...
                <p className="text-[10px] text-white/40 uppercase tracking-widest font-bold">Equipe Alfa Motos</p>
              </div>
